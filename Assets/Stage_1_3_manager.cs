...
public class Stage_1_3_manager : MonoBehaviour
{
     public Dialogue[] dialogue;
        ...
        public GameObject wirePuzzleHud;
        public float x;
        public WirePuzzleSystem wirePuzzle;

        public InputField[] InputAnswer;
        bool isAnswerCorrect=false;
        bool isAnswerSubmited=false;
        int [] coordinateAnswer1={1,2};
        int [] coordinateAnswer2={1,2};
    ...
    void Update()
    {
        ...
        if(dialogue[2].isFinish&&dialogueManager.state==DialogueState.End){
            if(wirePuzzle.isPuzzleFinish){
                CutSceneEnd.SetActive(true);
                wirePuzzleHud.SetActive(false);
            }else{
                wirePuzzleHud.SetActive(true);
            }
        }
        // if(dialogue[3].isFinish&&dialogueManager.state==DialogueState.End){
        //     CutSceneEnd.SetActive(true);
        // }
